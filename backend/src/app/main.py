...
from app.api import auth, backtest, crisis, portfolio, screening
...
# 데이터 API 전체가 레이어드 도메인(app/domains/*)으로 이관 완료 — 단일 aggregate로 마운트.
app.include_router(domain_router, dependencies=_protected)
